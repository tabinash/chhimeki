        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="px-4 py-2 bg-blue-600 text-white rounded-full text-sm font-bold hover:bg-blue-700 transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
                        {isSaving ? (
            ...
            <div className="max-w-md mx-auto">
                ...
                <div className="bg-white p-6 mb-2">
                    <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wide mb-4">Profile</h2>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="font-bold text-gray-900">{formData.name || user.name}</p>
                ...
                <div className="bg-white p-6 mb-2">
                    <h2 className="text-sm font-bold text-gray-500 uppercase tracking-wide mb-4">Account Information</h2>
