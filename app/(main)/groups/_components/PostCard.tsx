...
import { FeedItemResponse } from "@/types/api/group";
            ...
            <div className="bg-white border-b border-gray-100">
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <button className="flex items-center gap-2 px-3 py-1 text-[18px] bg-[#e4e1dd] rounded-full font-medium transition-colors text-gray-900 hover:text-blue-500">
